...
export default function ListUserPage() {
  const [companies, setCompanies] = useState<UserResult[]>([]);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `/api/masterdata/users?search=${search}&limit=${limit}&page=${page}`,
        {
          headers: {
  ...
  return (
    <div className="px-4 min-h-lvh">
      {/* Headers */}
      <h1 className="text-4xl leading-relaxed border-b">ListUser Page</h1>
            ...
            <tbody>
              {companies.map((value, idx) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{value.company?.companyname}</td>
